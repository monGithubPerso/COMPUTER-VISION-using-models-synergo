...
class ColorNames:
    ...
    @staticmethod
    def findNearestWebColorName(color):  
        return ColorNames.findNearestColorName(color,ColorNames.WebColorMap)
    
    @staticmethod
    def findNearestImageMagickColorName(color):  
        return ColorNames.findNearestColorName(color,ColorNames.ImageMagickColorMap)
